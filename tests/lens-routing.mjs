...
check("reduced motion shows a stable question without automatic rotation", client.includes("if (REDUCED_MOTION.matches || DAILY_PAGE_ID || views.home.hidden || homeHeroPaused) return") && client.includes("animate && !REDUCED_MOTION.matches"));
...
check("the app bundle is freshly versioned", page.includes('why-app.js?v=20260905-01'));
