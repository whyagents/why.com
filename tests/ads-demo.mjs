...
check("the adapter loads before the shared client", page.includes("ads-demo.js") && page.includes("why-app.js?v=20260915-ads01"));
...
check("the fourth answer remains a normal WHY answer", typeof sponsored.answer === "string" && sponsored.answer.length > 40 && sponsored.voiceNote.pulls.length === 3);
...
check("the lead form is campaign-configured and consent gated", adapter.campaign.fields.length >= 8 && adapter.campaign.fields.some((field) => field.name === "email" && field.required) && adapterSource.includes("contactConsent"));
